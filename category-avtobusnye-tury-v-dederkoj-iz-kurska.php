...
<section class="booking-title-wrapper" style="background-image: url(<?php echo $banner?>);">
  <div class="container-booking">
    <h1 class="booking-title">Автобусные туры в Дедеркой <?php echo carbon_get_theme_option('skvoznoye_godir'); ?></h1>
  </div>
</section>
...
<div class="s-partnership" style="display:none;">comu2v0Go7hgBPq6LbH2DKXciE0YeKAX10X93S9e2Oo%3D</div>
