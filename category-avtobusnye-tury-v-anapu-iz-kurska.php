...
<section class="booking-title-wrapper" style="background-image: url(<?php echo $banner?>);">
  <div class="container-booking">
    <h1 class="booking-title">Автобусные туры в Анапу <?php echo carbon_get_theme_option('skvoznoye_godir'); ?> 
    </h1>
  </div>
</section>
...
<div class="line PageContent exkursTur turi-more-cat _side-wrapper">
  <div class="centerInLine">
    ...
    <div class="s-partnership" style="display:none;">jEYKsbKqHOAvZpsdNuf9EZokKPsjxVNQO%2BhqPusRtF4%3D</div>
