...
<section class="booking-title-wrapper" style="background-image: url(<?php echo $banner?>);">
  <div class="container-booking">
    <h1 class="booking-title">Автобусные туры в Крым <?php echo carbon_get_theme_option('skvoznoye_godir'); ?>
      </h1>
  </div>
</section>
...
<div class="line PageContent exkursTur turi-more-cat _side-wrapper">
  <div class="centerInLine">
    ...
    <div class="s-partnership" style="display:none;">JTs7ZMYnVUldEivtBa8Zs5aEFNuyjsKfhjUK7LewaBc%3D</div>
