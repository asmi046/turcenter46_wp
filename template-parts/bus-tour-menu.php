...
<!-- 			<li class="menu-bus-li__top-tur">
			...
			<li class="menu-bus-li menu-bus-li_ya">
				...
				<ul class="sub-menu">
					<li class = "cat-item"><a href="<?php echo get_permalink(6978)?>">Симферополь</a></li> 
					<li class = "cat-item"><a href="<?php echo get_permalink(6976)?>">Алушта</a></li>
					<li class = "cat-item"><a href="<?php echo get_permalink(6974)?>">Гурзуф</a></li>
					<li class = "cat-item"><a href="<?php echo get_permalink(6050)?>">Ялта</a></li> 
				</ul>  
			</li>
