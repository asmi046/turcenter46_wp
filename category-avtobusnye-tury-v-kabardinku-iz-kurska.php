...
<section class="booking-title-wrapper" style="background-image: url(<?php echo $banner?>);">
  <div class="container-booking">
    <h1 class="booking-title">Автобусные туры в Кабардинку <?php echo carbon_get_theme_option('skvoznoye_godir'); ?></h1>
  </div>
</section>
...
<div class="line PageContent exkursTur turi-more-cat _side-wrapper">
  <div class="centerInLine">
    ...
    <div class="s-partnership" style="display:none;">m3sSbPZzWSL0nIN7hEFdEccWAphKqxz1E0FnN5%2BCqvI%3D</div>
