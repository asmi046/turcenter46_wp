...
<section class="booking-title-wrapper" style="background-image: url(<?php echo $banner?>);">
  <div class="container-booking">
    <h1 class="booking-title">Автобусные туры в Геленджик <?php echo carbon_get_theme_option('skvoznoye_godir'); ?>
      </h1>
  </div>
</section>
...
<div class="s-partnership" style="display:none;">Au8wppYic3UqcpF1Z66w4exwkMLECHaiQogs%2F4fFTv8%3D</div>
