...
<section class="booking-title-wrapper" style="background-image: url(<?php echo $banner?>);">
  <div class="container-booking">
    <h1 class="booking-title">Автобусные туры в Лазаревское <?php echo carbon_get_theme_option('skvoznoye_godir'); ?></h1>
  </div>
</section>
...
<div class="line PageContent exkursTur turi-more-cat _side-wrapper">
  <div class="centerInLine">
    ...
    <?php get_template_part('template-parts/hint-arrow');?>

    <script type="text/javascript" charset="utf-8" src="https://stells.info/assets/js/partner.fire.js"></script>
<div class="s-partnership" style="display:none;">KlVJg4j8dP6CyxsxfROxncE9Qk%2BLv7EUD50Xh%2FqazPE%3D</div>
