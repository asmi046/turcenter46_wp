...
<section class="booking-title-wrapper" style = "display:block; background: url(<?php bloginfo('template_url');?>/images/b/kremlevskaya-yelka.jpg); background-position:center center; background-size:cover;" class = "b">
	<div class="container-booking">
		<h1 class="booking-title">НОВОГОДНИЕ ТУРЫ ПО РОССИИ</h1>
	</div>
</section>
