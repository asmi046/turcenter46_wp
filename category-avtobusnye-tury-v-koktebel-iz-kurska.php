...
<section class="booking-title-wrapper" style="background-image: url(<?php echo $banner?>);">
  <div class="container-booking">
    <h1 class="booking-title">Автобусные туры в Коктебель <?php echo carbon_get_theme_option('skvoznoye_godir'); ?>
      </h1>
  </div>
</section>
...
<div class="s-partnership" style="display:none;">hmmOSNnIioqYeZcHwQhwhSD1vN3d8iDLguxgbFZWTg0%3D</div>
