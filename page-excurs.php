...
/*
Template Name: Экскурсионный тур (New) 
WP Post Template: Экскурсионный тур (New) 
...
<div class="breadcrumb breadcrumb-excurs breadcrumbMrBottom container"> 
	<?php
			...
			<div class="excurs-content">
				<div class="excurs-btn__wrapper">
					<div class="excurs-btn__content">
						...
						<div class="excurs-btn__complex-price">
					...
					<div class = "panelInstrument panelInstrument__excurs">
						<?php 
						if (carbon_get_the_post_meta('checkbox_pay_exc') ){
							?>
								<a class = "bluebtn payexcurs" href="<?php echo get_the_permalink(8985);?>?type=ekskursionka&price=<? echo carbon_get_the_post_meta('price');?>&message=<? echo get_the_title() ?>&pic=<?php echo get_the_post_thumbnail_url( get_the_ID(), "medium" ) ?>">Купить On-Line</a>
								<!-- <div class = "bluebtn payTourModal payexcurs" data-price = "<? echo carbon_get_the_post_meta('price');?>" data-winheader='Купить тур:'>Купить On-Line</div> -->
							<?
						}	
						?> 
						<div onclick = "window.print()" class = "bluebtn printRn printexcurs">На печать</div>
						<div class ="bluebtn zayavTurVuhModal quest-btn g-button" data-winheader="Задать вопрос по туру:" data-winsubheader="Отправьте заявку и наши специалисты свяжутся с Вами в течении 15 минут">Забронировать место</div>
