...
<section class="booking-title-wrapper" style="background-image: url(<?php echo $banner?>);">
  <div class="container-booking">
    <h1 class="booking-title">Автобусные туры в Феодосию <?php echo carbon_get_theme_option('skvoznoye_godir'); ?>
      </h1>
  </div>
</section>
...
<div class="line PageContent exkursTur turi-more-cat _side-wrapper">
  <div class="centerInLine">
    ...
    <div class="s-partnership" style="display:none;">Ke7rT%2BmzzpahGTdgzX3EW6%2Fsfmab9y2jmG4XO%2BjGno8%3D</div>
