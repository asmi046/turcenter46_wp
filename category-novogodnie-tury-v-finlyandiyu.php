...
<script>
	...
	<div class = "line banerLine banerLineInPage">
		<div class = "allB">
			<div style = "display:block; background: url(<?php bloginfo('template_url');?>/images/b/budapeshtBig.jpg); background-position:center center; background-size:cover;" class = "b">
